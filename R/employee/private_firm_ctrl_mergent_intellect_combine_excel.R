...
## dir names
proj_dir <- "C:/Users/steph/Google Drive/PhD/Dissertation/competition networks/compnet2"
...
version_dir <- file.path(proj_dir,'R','employee')
sup_data_dir <- file.path(proj_dir,'R','employee_sup_data')  ## supplmental data dir

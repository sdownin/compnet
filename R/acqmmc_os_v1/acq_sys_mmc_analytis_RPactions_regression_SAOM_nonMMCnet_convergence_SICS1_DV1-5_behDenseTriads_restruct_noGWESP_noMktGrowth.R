...
# {
  ...
  sysEff <- includeEffects(sysEff, behDenseTriads,# behDenseTriads,
                           name="depNetI", interaction1 = 'depMMC')
  #
  sysMod <- sienaAlgorithmCreate(projname='sys-mmc-acq-test-proj-converg-VDcut-behDenseTriad_restruct_1-Inf_H1ab_H2-0_noGWESP_noMktGrowth', 
                                 firstg = 0.12,  ## default: 0.2
  ...
  .prefix <- 'SAOM_1-Inf_H1ab_H2_noGWESP_noMktGrowth_GOF'
  ...
  saveRDS(list(res=sysResAMC0, mod=sysMod, dat=sysDat, eff=sysEff),
          file = 'acq_sys_mmc_sysResAMC0_converg_DVcut_behDenseTriad_restruct_1-Inf_H1ab_H2_noGWESP_noMktGrowth.rds')

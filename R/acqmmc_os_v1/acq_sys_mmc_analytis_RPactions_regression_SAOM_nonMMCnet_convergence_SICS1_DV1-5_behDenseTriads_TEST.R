...
# {
  ...
  ##
  ##-----------------------------------------------------------------------
  sysDat <- sienaDataCreate(depMMC, depNetI, depAcq, depProd,  #depNonAcq, depNetR, depNetI
  ...
  sysEff <- includeEffects(sysEff, behDenseTriads,# behDenseTriads,
                           name="depTac", interaction1 = 'depMMC')
  #
  sysMod <- sienaAlgorithmCreate(projname='sys-mmc-acq-test-proj-converg-VDcut-behDenseTriad_TEST-0', 
  ...
  saveRDS(list(res=sysResAMC0, mod=sysMod, dat=sysDat, eff=sysEff),
          file = 'acq_sys_mmc_sysResAMC0_H1ab_H2_converg_DVcut_behDenseTriad_TEST.rds')

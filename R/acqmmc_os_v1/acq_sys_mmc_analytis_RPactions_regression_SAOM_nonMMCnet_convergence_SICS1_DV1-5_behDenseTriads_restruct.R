...
# {
  ...
  # sysEff <- includeInteraction(sysEff, transTriads, egoX,
  #                             name="depMMC", type='creation', interaction1 = c('','depNetR'))
  # sysEff <- includeEffects(sysEff, transTriads,
  #                          name="depMMC", include = FALSE)
  # sysEff <- includeEffects(sysEff, gwesp,
  #                          name="depMMC", type='eval')
  # sysEff <- includeInteraction(sysEff, gwesp, egoX,
  #                             name="depMMC", interaction1=c('','depNetR'))
  # sysEff <- includeInteraction(sysEff, gwesp, egoX,
  #                             name="depMMC", interaction1=c('','depNetR'))
  # sysEff <- includeEffects(sysEff,sameXTransTrip,
  #                          name="depMMC", type='eval', interaction1 = 'depNetI')
  
  # sysEff <- includeEffects(sysEff,totDist2,
  #                          name="depMMC", type='eval', interaction1 = 'depNetR')
  # sysEff <- includeEffects(sysEff, sameXTransTrip,
  #                          name="depMMC", type='endow', interaction1 = c('depNetI'))
  # sysEff <- includeInteraction(sysEff, egoX, transTriads,
  #                             name="depMMC", type='eval', interaction1 = c('depNetR',''))
  # sysEff <- includeInteraction(sysEff, egoX, transTriads,
  #                              name="depMMC", type='creation', interaction1 = c('depNetR',''))
  # sysEff <- includeInteraction(sysEff, inPopSqrt, transTriads,
  #                          name="depMMC", type = 'creation', interaction1 = c('',''))
  ## CONTROL BEHVAIOR -----------------------------------------
  ...
  sysEff <- includeEffects(sysEff, behDenseTriads,# behDenseTriads,
                           name="depNetI", interaction1 = 'depMMC')
  #
  # sysEff <- includeInteraction(sysEff, totAlt, behDenseTriads,# behDenseTriads,
  #                              name="depNetI", interaction1 = c('depMMC','depMMC'))
  # sysEff <- includeInteraction(sysEff, totAlt, behDenseTriads,# behDenseTriads,
  #                              name="depNetR", interaction1 = c('depMMC','depMMC'))
  #
  sysMod <- sienaAlgorithmCreate(projname='sys-mmc-acq-test-proj-converg-VDcut-behDenseTriad_restruct_1-Inf_H1ab_H2-0_assort', 
                                 firstg = 0.1,  ## default: 0.2
                                 n2start=150,    ## default: 2.52*(p+7)
                                 nsub = 4,       ## default: 4
                                 seed=131, maxlike=F)
  ...
  saveRDS(list(res=sysResAMC0, mod=sysMod, dat=sysDat, eff=sysEff),
          file = 'acq_sys_mmc_sysResAMC0_converg_DVcut_behDenseTriad_restruct_1-Inf_H1ab_H2_assort.rds')
...
### 
  ...
  sysEff <- getEffects(sysDat)
  # effectsDocumentation(sysEff)
  sysEff <- includeEffects(sysEff, gwesp, inPopSqrt,
                           name="depMMC")
  sysEff <- includeEffects(sysEff, egoX,
                           name="depMMC", interaction1 = 'covAge')
  sysEff <- includeEffects(sysEff, X,
  ...
  sysMod <- sienaAlgorithmCreate(projname='sys-mmc-acq-test-proj-converg-VDcut-H1ab-0', 
                                 firstg = 0.09,  ## default: 0.2
                                 n2start=170,    ## default: 2.52*(p+7)
                                 nsub = 5,       ## default: 4
                                 seed=137, maxlike=F)
  # ##***  save.image('acq_sys_mmc_SAOM_AMC.rda')  ##***
  ...
  saveRDS(list(res=sysResH1ab, mod=sysMod, dat=sysDat, eff=sysEff),
          file = 'acq_sys_mmc_sysResAMC0_converg_DVcut_H1ab.rds')
  ...
  saveRDS(list(res=sysResH2, mod=sysMod, dat=sysDat, eff=sysEff),
          file = 'acq_sys_mmc_sysResAMC0_converg_DVcut_H2.rds')
  ...
  saveRDS(list(res=sysResAMC0ctrl2, mod=sysMod, dat=sysDat, eff=sysEff),
          file = 'acq_sys_mmc_sysResAMC0_converg_DVcut_ctrl2.rds')
  ...
  saveRDS(list(res=sysResAMC0ctrl, mod=sysMod, dat=sysDat, eff=sysEff),
          file = 'acq_sys_mmc_sysResAMC0_converg_DVcut_ctrl.rds')
  ...
  sysNameMap <- list(
    ...
    `transitive triads`='Transitive Triads (portion of SMMC)',
    `creation: transitive triads`='Transitive Triads Creation (increased SMMC)',
    `endow: transitive triads`='Transitive Triads Maintenance (maintaining SMMC)',
    #---------------------------------------------
  ...
  saveRDS(sysResList, file="sys_MMC_SAOM_res_list_microsoft_DVcut_1-Inf_2010-2016.rds")
  tab <- saomTable(sysResList, digits = 3, nameMap = sysNameMap,
            file="sys_MMC_SAOM_res_table_microsoft_DVcut_1-Inf_2010-2016.csv")

...
m4venusfile <- 'C:\\Users\\T430\\Google Drive\\PhD\\Dissertation\\competition networks\\compnet2\\amj_rnr2_results\\firmctrl\\fit_qualtrics_pd11_R2000_m4.rds'
...
## D2 networks check
### new stephen's laptop vs. Venus R2
r2.quald2 <- 'C:\\Users\\T430\\Google Drive\\PhD\\Dissertation\\competition networks\\compnet2\\amj_rnr2_results\\firmctrl\\fit_qualtrics_pd11_R2000_m4_d2.rds'
...
.repl <- function() {
  ...
  res_repl_dir <- 'C:\\Users\\T430\\Google Drive\\PhD\\Dissertation\\competition networks\\compnet2\\amj_rnr2_results_repl'
  for (d in 2:3)
  {
    cat(sprintf('\n\nd = %s\n\n',d))
    ## load
